...
public class Savannah {
	...
	private SerVivo tablero[][];// podria ser en vez de SerVivo, Object
/**
 * @implSpec
 * Hacemos una savana de 10x10 (se podría modificar)
 */
	public Savannah() {
		diasJuego = 1;
 ...
 */
	 ...
	 * 
	 * @param a
	 * sirve para introducir la y
	 * @param b
	 * sirve para introducir la x
	 * @return
	 * devuelve el objeto en esa posicion
	 */
public Object obtenerTablero(int a, int b) {
	 return tablero[a][b];
}
}
